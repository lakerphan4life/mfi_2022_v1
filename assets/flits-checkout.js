...
//                     var applied_code_div = document.querySelector('.applied-reduction-code__information');
    ...
    var remove_attribute = ["sku","featured_image","product_description","title","url","handle","product_type","product_title","discounts","variant_options","options_with_values","variant_title"];
